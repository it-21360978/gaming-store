...
export default function footer() {
  return (
    <div>
        ...
        <footer className="p-4 bg-blue-900 sm:p-6 dark:bg-gray-800 backdrop-blur-md rounded-t-xl">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <Link to ="/" className="flex items-center">
                    <img src={logo} className="mr-3 h-16 rounded-full" alt="Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">GAMES STORE</span>
                </Link>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-64">
                <div>
                    ...
                    <ul className="text-white">
                        <li className="mb-4">
                            <p>As a customer-centered store, we strive for excellence in customer service and support. 
                                Our knowledgeable staff is ready to assist you in finding the perfect game or accessory to suit your playstyle.</p>
                        </li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-white sm:text-center dark:text-white">© 2023 <Link to ="" className="hover:underline">Games Sore™</Link>. All Rights Reserved.
            </span>
